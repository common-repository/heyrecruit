...
<div class="hr_job_header_details">
    <div class="hr_job_info">
        <style>
            .hr_job_info svg {
                fill: <?php echo  esc_attr(HEYRECRUIT_CUSTOM_COLOR);?>
            }
        </style>
        <?php if ($args['jobAddress']): ?>
            <span class="hr_job_info_location">
          ...
          <?php echo $args['jobAddress']; ?>
        </span>
        <?php endif; ?>
        <?php if ($args['jobEmployment']): ?>
            <span class="hr_job_info_employment">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path
                        d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/></svg>
            <?php echo $args['jobEmployment']; ?>
        </span>
        <?php endif; ?>
        <?php if ($args['jobDepartment']): ?>
            <span class="hr_job_info_department">
                ...
                <?php echo $args['jobDepartment']; ?>
            </span>
        <?php endif; ?>
        <?php if ($args['jobAllowHomeOffice']): ?>
            <span class="hr_job_info_homeoffice">
                ...
                <?php echo $args['jobAllowHomeOffice']; ?>
            </span>
        <?php endif;
        if (!empty($args['jobMinSalary']) && !empty($args['jobMaxSalary'])) {
            if ($args['jobMinSalary'] == $args['jobMaxSalary']) { ?>
                <span class="hr_job_info_salary">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path
                ...
                <span class="hr_job_info_salary">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path
                                d="M0 112.5V422.3c0 18 10.1 35 27 41.3c87 32.5 174 10.3 261-11.9c79.8-20.3 159.6-40.7 239.3-18.9c23 6.3 48.7-9.5 48.7-33.4V89.7c0-18-10.1-35-27-41.3C462 15.9 375 38.1 288 60.3C208.2 80.6 128.4 100.9 48.7 79.1C25.6 72.8 0 88.6 0 112.5zM288 352c-44.2 0-80-43-80-96s35.8-96 80-96s80 43 80 96s-35.8 96-80 96zM64 352c35.3 0 64 28.7 64 64H64V352zm64-208c0 35.3-28.7 64-64 64V144h64zM512 304v64H448c0-35.3 28.7-64 64-64zM448 96h64v64c-35.3 0-64-28.7-64-64z"/></svg>
                    <?php echo $args['jobMinSalary']; ?>–<?php echo $args['jobMaxSalary']; ?> €
                </span>
                <?php
            }
        } elseif (!empty($args['jobMinSalary']) || !empty($args['jobMaxSalary'])) { ?>
            <span class="hr_job_info_salary">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path
                            d="M0 112.5V422.3c0 18 10.1 35 27 41.3c87 32.5 174 10.3 261-11.9c79.8-20.3 159.6-40.7 239.3-18.9c23 6.3 48.7-9.5 48.7-33.4V89.7c0-18-10.1-35-27-41.3C462 15.9 375 38.1 288 60.3C208.2 80.6 128.4 100.9 48.7 79.1C25.6 72.8 0 88.6 0 112.5zM288 352c-44.2 0-80-43-80-96s35.8-96 80-96s80 43 80 96s-35.8 96-80 96zM64 352c35.3 0 64 28.7 64 64H64V352zm64-208c0 35.3-28.7 64-64 64V144h64zM512 304v64H448c0-35.3 28.7-64 64-64zM448 96h64v64c-35.3 0-64-28.7-64-64z"/></svg>
                <?php echo !empty($args['jobMinSalary']) ? $args['jobMinSalary'] : $args['jobMaxSalary']; ?> €
            </span>
            <?php
        }
        ?>
